...
class Dor{
	static down_or_left = 0;
}
// var down_or_left=0;
// function dateDropDown(){
//   // console.log("works")
//   var down_arrow = document.querySelector(".fa-chevron-down");
//   if(Dor.down_or_left==0){
//   down_arrow.style.transform="rotate(0deg)";
//   console.log("down");
//   // console.log(document.getElementsByClassName("today-date")[0]);
//     // document.getElementsByClassName("today-date")[0].blur();
//   Dor.down_or_left = 1;
//   } else {
